// src/app/managements/projects/new/page.tsx
...
export default function NewProjectPage() {
  return (
    <div className="grid gap-4 max-w-xl">
      <h1 className="text-xl font-bold">เพิ่ม Project</h1>

      <form method="post" action="/managements/projects/api/create" className="card p-4 grid gap-3">
        <input
          name="name"
