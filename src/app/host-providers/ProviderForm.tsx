...
export default function ProviderForm({
  ...
  const [state, formAction, pending] = useActionStateCompat<ActionState, FormData>({} as any, { ok:false, message:"" });
  // NOTE: pass action correctly (workaround for TS):
  const onAction = (action as any);

  return (
    <form action={onAction} className="card p-4 grid gap-3 max-w-xl">
