...
const categories: CategoryItem[] = [
  { title: "ลงเวลาเข้างาน", desc: "ระบบลงเวลาเข้างาน", emoji: "🎰", href: "#" },
  { title: "จัดการงานรายวัน", desc: "จัดการรายละเอียดการทำงานส่วนบุคคล", emoji: "🏆", href: "#" },
  { title: "ล็อตเตอรี่", desc: "หวยไทย ตัวจัดการ API", emoji: "🎟️", href: "https://thai-lotto-checker.vercel.app/latest" },
  { title: "ส่วนเสริม", desc: "ส่วนเสริมอื่นๆ สำหรับการทำงาน", emoji: "🎁", href: "#" },
];
